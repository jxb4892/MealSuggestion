...
def main():
    ...
    generating three tables: a table with product ID as a key and list of recipes that contains its key as
    one of the ingredients, a table mapping a product ID and its name, and a table mapping a recipe to a link where
